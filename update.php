...
<center><table border="5" bgcolor="Lavender">
 <h2 style="color:white"><b>UPDATE</b></h2><br>
...
<a style="color:white" href="#">UPDATE</a>&nbsp&nbsp&nbsp&nbsp
...
if(isset($_POST['submit']))
 ...
 $q1=mysql_query("UPDATE customer SET CUSTOMER_ID='$cid',FIRSTNAME='$cap1',LASTNAME='$cap2',EMAIL='$email',PHONE='$phone',ADDRESS='$address',STREET='$street',CITY='$city',PINCODE='$pin' where CUSTOMER_ID =$cid");
if($q1)
{
